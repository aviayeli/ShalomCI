...
- **נגישות (WCAG 2.2):** ממומש - עמודת הסטטוס תמיד כוללת גם אייקון מפורש (⛔/⚠️/✅/❓) וגם טקסט (`status_icon` ב-`table_rows.py`), כך שהתראת EOL/NRND אינה מסתמכת על צבע בלבד.
