...
- **העשרת נתונים משלושה ספקים (Mouser + DigiKey + Octopart):** מחזור חיים, מלאי, זמן אספקה ומחיר נשלפים בנפרד מכל ספק ומוצגים side-by-side בעמודות נפרדות בטבלה, כדי לאפשר השוואה בין ספקים על אותו רכיב.
